...
public class Triangle : ITraceable, ITransform
{
    public Point3 Vertex1 {get => plane.PointA;}
    public Point3 Vertex2 {get => plane.PointB;}
    public Point3 Vertex3 {get => plane.PointC;}
    ...
    public Triangle(Point3 vertex1, Point3 vertex2, Point3 vertex3)
    {
        ...
        var edge1 = vertex1 - vertex2;
        var edge2 = vertex1 - vertex3;
        var edge3 = vertex2 - vertex3;
        if (!DoTriangleExist(edge1.Lenght, edge2.Lenght, edge3.Lenght))
        {
    ...
    public static Triangle TriangleWithNormals(
    ...
    private static bool DoTriangleExist(float edge1, float edge2, float edge3)
    {
